##
##  MoreInfo   (c)2010 by SatCat (from Russia@Sakhalin_region@Nevelsk_city)
##
...
#			self.type = self.SID
	...
	def getText(self):
		...
		if not info:
			return "No service.info() (QuickServiceInfo error)"
		...
		else: return "sTransponderData is None (QuickServiceInfo error)"
		return "QuickServiceInfo usage error!"
