...
class ScNewSelection(Screen):
	if config.plugins.SoftcamMenu.showEcm.value:
		skin = """
			<screen name="ScNewSelection" position="center,center" size="650,500" title="Softcam Setup">
				...
				<widget name="text" position="5,220" size="345,260" zPosition="2"  font="Regular;17" />
				<widget name="text1" position="350,220" size="320,260" zPosition="2"  font="Regular;17" />
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/PLi/SoftcamSetup//images/div-h.png" position="0,450" zPosition="2" size="650,2" />
				<ePixmap position="150,490" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/PLi/SoftcamSetup/images/red.png" transparent="1" alphatest="on" />
				<ePixmap position="400,490" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/PLi/SoftcamSetup/images/green.png" transparent="1" alphatest="on" />
				<widget name="key_red" position="150,460" zPosition="2" size="170,25" valign="center" halign="center" font="Regular;21" transparent="1" />
				<widget name="key_green" position="400,460" zPosition="2" size="170,25" valign="center" halign="center" font="Regular;21" transparent="1" />
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/PLi/SoftcamSetup//images/key_menu.png" position="20,460" zPosition="2" size="50,40" alphatest="on" />
			</screen>"""	
	else:
		skin = """
